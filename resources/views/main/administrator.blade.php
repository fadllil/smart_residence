    ...
    <aside class="main-sidebar fixed offcanvas shadow">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview"><a href="{{route('admin.user')}}">
                        <i class="icon-users blue-text"></i> <span>Administrator</span>
                    </a>
                </li>
                <li class="treeview"><a href="{{route('admin.rt')}}">
                        <i class="icon-building blue-text"></i> <span>RT</span>
                    </a>
                </li>
                <li class="treeview"><a href="{{route('admin.warga')}}">
                        <i class="icon-users green-text"></i> <span>Warga</span>
                    </a>
                </li>
            </ul>
        </section>
                    ...
                    <ul class="navbar-nav p-t-10">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right b-0 shadow1">
                                ...
                                <a class="dropdown-item" href="{{route('logout')}}"><i class="icon-money"></i> Logout </a>
                            </div>
                        </li>
                    </ul>
                </div>
