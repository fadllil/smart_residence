            ...
            <div class="modal-content no-r "><a href="#" data-dismiss="modal" aria-label="Close"
                ...
                <div
                    ...
                    <div class="light p-10 b-t-b">
                        <form action="/kab_kota/create" method="post">
                            @csrf
                            <div class="form-group">
                                <label for="provinsi">Nama Provinsi</label>
                                <select class="form-control" id="select" name="id_provinsi" required>
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama" name="nama" type="text" class="form-control form-control-lg"
                                       placeholder="Nama Kab/Kota" required>
                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="datatableKabKota" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Provinsi</th>
                ...
                <div class="modal-content no-r "><a href="#" data-dismiss="modal" aria-label="Close"
                    ...
                    <div
                        ...
                        <div class="text-center p-40 p-b-0" style="margin-bottom: 10px">
                            ...
                            <a href="kab_kota/delete/{{$d->id}}" class="btn btn-primary btn-fab-md" style="width: 80px">Ya</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog width-400" role="document">
                <div class="modal-content no-r "><a href="#" data-dismiss="modal" aria-label="Close"
                    ...
                    <div
                        ...
                        <div class="light p-10 b-t-b">
                            <form action="kab_kota/update/{{$d->id}}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="provinsi">Nama Provinsi</label>
                                    <select class="form-control" id="select" name="id_provinsi" required>
                                        <option selected disabled>Pilih Provinsi</option>
                                        @foreach($provinsi as $p)
                                            <option @if($d->id_provinsi == $p->id) selected @endif value="{{$p->id}}">{{$p->nama}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
...
@section('script')
    <script>
        $(function() {
            $('#datatableKabKota').DataTable({
                processing: true,
                responsive: true,
                serverSide: true,
                info: true,
                ajax: 'kab_kota/datatable',
                columns: [{
                    "data": null,
                    'sortable': false,
