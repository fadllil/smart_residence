                ...
                <div
                    ...
                    <div class="light p-10 b-t-b">
                        <form action="kecamatan/create" method="post">
                            ...
                            <div class="form-group">
                                <label for="provinsi">Nama Kab/Kota</label>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="datatableKecamatan" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Provinsi</th>
                ...
                <div class="modal-content no-r "><a href="#" data-dismiss="modal" aria-label="Close"
                    ...
                    <div
                        ...
                        <div class="text-center p-40 p-b-0" style="margin-bottom: 10px">
                            ...
                            <a href="kecamatan/delete/{{$d->id}}" class="btn btn-primary btn-fab-md" style="width: 80px">Ya</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog width-400" role="document">
                <div class="modal-content no-r "><a href="#" data-dismiss="modal" aria-label="Close"
                    ...
                    <div
                        ...
                        <div class="light p-10 b-t-b">
                            <form action="kecamatan/update/{{$d->id}}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="provinsi">Nama Provinsi</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="nama" name="nama" type="text" class="form-control form-control-lg"
                                           placeholder="Nama Kecamatan" value="{{$d->nama}}" required>
                                </div>
        ...
        $(function() {
            $('#datatableKecamatan').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'detail_kab_kota.detail_provinsi.nama',
                        name: 'provinsi'
                    },
                    {
                        data: 'detail_kab_kota.nama',
                        name: 'kabkota'
                    },
                    {
                        data: 'nama',
