            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="datatableKelurahan" class="table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Provinsi</th>
                ...
                <div class="modal-content no-r "><a href="#" data-dismiss="modal" aria-label="Close"
                    ...
                    <div
                        ...
                        <div class="text-center p-40 p-b-0" style="margin-bottom: 10px">
                            ...
                            <a href="kelurahan/delete/{{$d->id}}" class="btn btn-primary btn-fab-md" style="width: 80px">Ya</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog width-400" role="document">
                <div class="modal-content no-r "><a href="#" data-dismiss="modal" aria-label="Close"
                    ...
                    <div
                        ...
                        <div class="light p-10 b-t-b">
                            <form action="kelurahan/update/{{$d->id}}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="provinsi">Nama Provinsi</label>
        ...
        $(function() {
            $('#datatableKelurahan').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'detail_kecamatan.detail_kab_kota.detail_provinsi.nama',
                        name: 'provinsi'
                    },
                    {
                        data: 'detail_kecamatan.detail_kab_kota.nama',
                        name: 'kabkota'
                    },
                    {
                        data: 'detail_kecamatan.nama',
                        name: 'kecamatan'
                    },
                    {
                        data: 'nama',
